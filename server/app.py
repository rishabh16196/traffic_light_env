...
"""
FastAPI application for the Traffic Light Env Environment.

This module creates an HTTP server that exposes the TrafficLightEnvironment
...
app = create_app(
    TrafficLightEnvironment,
    TrafficLightAction,
    TrafficLightObservation,
    env_name="traffic_light_env",
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m traffic_light_env.server.app
    ...
    multiple workers:
        uvicorn traffic_light_env.server.app:app --workers 4
    """
    import uvicorn
